...
latex.table <- rbind(
  ...
  paste("Coef. on imposed function form of $\\mu_t$ &",
        "$\\theta_{a,opt} $ &",
        "\\eqref{eq:mu}&",
        make.entry(model_sol$theta.opt[1],format.nb4),
        "&",
        "",
        "\\\\",sep=""),
  paste("Coef. on imposed function form of $\\mu_t$ &",
        "$\\theta_{b,opt} $ &",
        "\\eqref{eq:mu}&",
        make.entry(abs(model_sol$theta.opt[2]),format.nb4),
        "&",
        "",
        "\\\\",sep="")
)
