...
In our Figure 2, the line labeled "ACE-Joos" is based on data extracted from [Christian Traeger´s repository](https://www.openicpsr.org/openicpsr/project/154141/version/V1/view), which utilizes inputs originally obtained from Fortunat Joos (Joos et al., 2013). The latter work is licensed under [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).
